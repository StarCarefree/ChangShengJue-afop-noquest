...
public class CabinetEntity extends RandomizableContainerBlockEntity {
    ...
    private final ContainerOpenersCounter openersCounter = new ContainerOpenersCounter() {
        ...
        protected boolean isOwnContainer(Player player) {
            if (player.containerMenu instanceof ChestMenu chestMenu) {
                return chestMenu.getContainer() == CabinetEntity.this;
            }
            return false;
        }
    };
    ...
    public CabinetEntity(BlockPos pos, BlockState state) {
        super(ChangShengJueBlocksEntities.CABINET_ENTITY.get(), pos, state);
    }

    public static void tick(Level level, BlockPos pos, BlockState state, CabinetEntity blockEntity) {
