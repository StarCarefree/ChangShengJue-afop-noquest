...
public class LongYuanSwordRender extends GeoItemRenderer<SoftSword> {
    public LongYuanSwordRender() {
        super(new DefaultedItemGeoModel<>(new ResourceLocation(ChangShengJue.MOD_ID,"long_yuan_sword")));
    }
