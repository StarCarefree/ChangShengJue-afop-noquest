 ...
 * 砖窑配方生成器
 */
public class BrickKilnRecipeBuilder implements RecipeBuilder {
    private final ItemStack result;
    private final List<IngredientEntry> ingredients = new ArrayList<>();
    private final Advancement.Builder advancement = Advancement.Builder.advancement();
    private String group = "";

    private BrickKilnRecipeBuilder(ItemStack result) {
        this.result = result;
    }

    public static BrickKilnRecipeBuilder brickKiln(ItemLike result) {
        return brickKiln(result, 1);
    }

    public static BrickKilnRecipeBuilder brickKiln(ItemLike result, int count) {
        return new BrickKilnRecipeBuilder(new ItemStack(result, count));
    }

    /**
     * 添加普通物品材料
     */
    public BrickKilnRecipeBuilder requires(ItemLike item) {
     ...
     * 添加带数量的普通物品材料
     */
    public BrickKilnRecipeBuilder requires(ItemLike item, int count) {
     ...
     * 添加标签材料
     */
    public BrickKilnRecipeBuilder requires(TagKey<Item> tag) {
     ...
     * 添加带数量的标签材料
     */
    public BrickKilnRecipeBuilder requires(TagKey<Item> tag, int count) {
     ...
     * 添加Ingredient材料
     */
    public BrickKilnRecipeBuilder requires(Ingredient ingredient) {
     ...
     * 添加带数量的Ingredient材料
     */
    public BrickKilnRecipeBuilder requires(Ingredient ingredient, int count) {
    ...
    private static class Result implements FinishedRecipe {
        ...
        public void serializeRecipeData(@NotNull JsonObject json) {
            json.addProperty("type", ChangShengJue.MOD_ID + ":brick_kiln");
